      ...
      <div className="mx-auto max-w-[1700px]">
        <header className="flex flex-wrap items-center justify-between gap-4 border-b border-ink/8 pb-8">
          <div>
            <Link
              href="/admin"
              className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.18em] text-ink/40 transition-colors hover:text-accent"
            >
              <ArrowLeft size={13} strokeWidth={1.7} />
              Torna all&apos;admin
            </Link>
            <h1 className="mt-5 font-display text-4xl font-bold uppercase text-ink md:text-6xl">
              Contenuti sito
            </h1>
